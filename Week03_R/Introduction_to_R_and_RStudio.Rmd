...
knitr::opts_knit$set(root.dir = normalizePath("/home1/wfjewell/490_cluster")) #TODO: edit this to show your path
```
...
age <- 20
birthday <- '12/02/2005'
three_fav_colors <- c('purple', 'blue', 'violet')
```
...
min(1, 1, 2, 3, 5, 8, 13, 21)
mean(1, 1, 2, 3, 5, 8, 13, 21)
mean(1, 1, 2, 3, 5, 8, 13, 21)
mode(1, 1, 2, 3, 5, 8, 13, 21)
summary(1, 1, 2, 3, 5, 8, 13, 21)
## call functions here
...
"cat" == "cat" & "fish" == "hamster" # TODO: make a prediction: F
